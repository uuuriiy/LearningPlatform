          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-semibold">Learnify</span>
              </div>
              <p className="text-gray-300 leading-relaxed">
                Empowering educators worldwide to create, share, and monetize their knowledge through our innovative learning platform.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Course Creator</a></li>
